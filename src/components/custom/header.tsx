...
<Select>
  <SelectTrigger className="w-[180px] focus:ring-0 hover:bg-blue-200 hover:border-blue-500">
    <SelectValue 
      placeholder="Select Restaurant"
      className="text-blue-700 font-bold italic" // Adding font effect and color
    />
  </SelectTrigger>
  <SelectContent>
    <SelectItem value="cheesy-delight">Dominos Pizza</SelectItem>
    <SelectItem value="pizza-hut">Pizza Hut</SelectItem>
    <SelectItem value="kids-corner">Chicago Pizza</SelectItem>
  </SelectContent>
</Select>
